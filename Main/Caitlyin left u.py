...
ellipse_left = {
    ...
    "num_points": 100,     # تعداد نقاط دایره برای رسم
    "color": pm.new_color(139, 69, 19, 255),  # رنگ قهوه‌ای ملایم
}

ellipse_right = {
    "radius_x": 340 ,      # شعاع افقی دایره (برای بیضی) - بزرگتر شده
    "radius_y": 280,      # شعاع عمودی دایره (برای بیضی) - بزرگتر شده
    "angle": 0,           # زاویه چرخش دایره به سمت راست
    "num_points": 100,     # تعداد نقاط دایره برای رسم
    "color": pm.new_color(139, 69, 19, 255),  # رنگ قهوه‌ای ملایم
}
...
while pm.overlay_loop():
    ...
    draw_rotated_ellipse(ellipse_right, 652, 476)
